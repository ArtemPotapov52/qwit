    ...
    <SafeAreaView style={s.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={[s.card, { overflow: 'hidden' }]}>
          ...
          <View style={s.rowDivider} />
          <SettingRow
            icon={<Path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" stroke={Colors.sub} strokeWidth={1.8} strokeLinejoin="round"/>}
            tint="#F0F1F3"
...
const s = StyleSheet.create({
  ...
  headerTitle: { fontFamily: Fonts.brand700, fontSize: 20, color: Colors.ink, letterSpacing: -0.8 },
  scroll: { paddingHorizontal: 18, paddingBottom: 40 },
  sectionLabel: {
    fontFamily: Fonts.brand600, fontSize: 12, color: Colors.faint,
  ...
  rowLabel: { flex: 1, fontFamily: Fonts.body400, fontSize: 14, color: Colors.ink },
  rowLabelDisabled: { color: Colors.faint },
  rowDivider: { height: 1, backgroundColor: Colors.hairline, marginLeft: 61 },
  disabledTag: { fontFamily: Fonts.body400, fontSize: 12, color: Colors.faint },
});
